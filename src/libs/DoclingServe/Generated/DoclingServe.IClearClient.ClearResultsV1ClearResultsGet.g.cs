...
namespace DoclingServe
{
    public partial interface IClearClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DoclingServe.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::DoclingServe.AutoSDKHttpResponse<global::DoclingServe.ClearResponse>> ClearResultsV1ClearResultsGetAsResponseAsync(
            double? olderThen = default,
            global::DoclingServe.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
    }
