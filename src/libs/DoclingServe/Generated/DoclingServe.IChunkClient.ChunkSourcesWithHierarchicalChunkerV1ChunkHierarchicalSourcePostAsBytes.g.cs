...
namespace DoclingServe
{
    public partial interface IChunkClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DoclingServe.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::DoclingServe.AutoSDKHttpResponse<byte[]>> ChunkSourcesWithHierarchicalChunkerV1ChunkHierarchicalSourcePostAsBytesAsResponseAsync(
