...
namespace DoclingServe
{
    ...
    public sealed partial class GraphCell
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::DoclingServe.JsonConverters.GraphCellLabelJsonConverter))]
...
#endif
        public GraphCell(
            global::DoclingServe.GraphCellLabel label,
            int cellId,
            string text,
            string orig,
            global::DoclingServe.ProvenanceItem? prov,
            global::DoclingServe.RefItem? itemRef)
        {
            this.Label = label;
            this.CellId = cellId;
