...
namespace DoclingServe
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::DoclingServe.AutoSDKRetryOptions Retry { get; set; } = new global::DoclingServe.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::DoclingServe.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::DoclingServe.IAutoSDKHook>();
        ...
        public global::DoclingServe.AutoSDKClientOptions AddHook(
            global::DoclingServe.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::DoclingServe.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::DoclingServe.AutoSDKClientOptions UseAuthorizationProvider(
            global::DoclingServe.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::DoclingServe.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::DoclingServe.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::DoclingServe.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::DoclingServe.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::DoclingServe.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::DoclingServe.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::DoclingServe.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::DoclingServe.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::DoclingServe.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::DoclingServe.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::DoclingServe.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::DoclingServe.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::DoclingServe.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::DoclingServe.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::DoclingServe.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::DoclingServe.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::DoclingServe.AutoSDKClientOptions clientOptions,
            global::DoclingServe.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::DoclingServe.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::DoclingServe.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::DoclingServe.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::DoclingServe.AutoSDKClientOptions clientOptions,
            global::System.Func<global::DoclingServe.IAutoSDKHook, global::DoclingServe.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::DoclingServe.AutoSDKHookContext context)
        {
