...
namespace DoclingServe
{
    ...
    public sealed partial class GraphLink
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::DoclingServe.JsonConverters.GraphLinkLabelJsonConverter))]
...
#endif
        public GraphLink(
            global::DoclingServe.GraphLinkLabel label,
            int sourceCellId,
            int targetCellId)
        {
            this.Label = label;
