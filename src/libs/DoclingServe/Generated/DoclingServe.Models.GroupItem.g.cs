...
namespace DoclingServe
{
    ...
    public sealed partial class GroupItem
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::DoclingServe.JsonConverters.GroupLabelJsonConverter))]
        public global::DoclingServe.GroupLabel? Label { get; set; }
        ...
        public GroupItem(
            ...
            string? name,
            global::DoclingServe.GroupLabel? label)
        {
